//
//  Api_AvatarChange.swift
//  AnimalBook
//
//  Created by Dmytro Ryshchuk on 26.05.17.
...
//        let chosenImage = info[UIImagePickerControllerOriginalImage] as! UIImage //2      //Original size of photo
        let chosenImage = info[UIImagePickerControllerEditedImage] as! UIImage //2          //Crop size of photo
        iv_avatar.contentMode = .scaleAspectFit //3
        iv_avatar.image = chosenImage //4
        ...
        let imageOrintationIsOkay = self.sFunc_imageFixOrientation(img: self.iv_avatar.image!)
